...
<head>
    ...
    <title>CSS Adventure Game - Level 4</title>
...
<body>
    <div class="game-container">
        <div class="game-info">
            ...
            <p>
                ยากขึ้นแล้ว! ตอนนี้มีกำแพงทั้งแนวตั้งและแนวนอน 
                เราต้องใช้ transform เพื่อเคลื่อนย้ายต้นไม้ไปหาน้ำ!
            </p>
        ...
        <div class="game-field">
            <div id="field" class="field">
                <div class="obstacle obstacle-horizontal"></div>
                <div class="obstacle obstacle-vertical"></div>
